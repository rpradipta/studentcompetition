...
namespace Todo
{
	public class App : Application
	{
		...
		public App()
		{
           ...
           // Resources.Add("primaryGreen", Color.FromHex("AC0F16")); 
           //Resources.Add("primaryDarkGreen", Color.FromHex("6FA22E"));
            
               

            var nav = new NavigationPage(new TodoListPage());
            nav.BarBackgroundColor = Color.FromHex("4346FF");
		...
		public static TodoItemDatabase Database
		{
			get
			{
				if (database == null)
				{
                    database = new TodoItemDatabase(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "SQLite.db3"));
				}
				return database;
			}
		}
